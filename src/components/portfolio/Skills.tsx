...
const groups = [
  {
    ...
    items: ["TypeScript", "JavaScript", "React", "Next.js", "Python", "Java", "C++", "C", "HTML", "CSS", "Tailwind CSS", "Supabase"],
  },
  {
    icon: Cpu,
    title: "Engineering",
    items: ["Responsive Design", "API Integration", "Authentication", "UI/UX Thinking", "SaaS Architecture", "Deployment"],
  },
  {
    icon: Megaphone,
